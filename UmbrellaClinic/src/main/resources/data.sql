...
INSERT INTO secretario (id, rut, nombre, rol, correo, password) VALUES
                                                                    (61, '60.000.001-1', 'Jorge Fuentes', 'SECRETARIO', 'jorge.fuentes@umbrella.cl', 'pass1'),
                                                                    (62, '60.000.002-2', 'Valentina Silva', 'SECRETARIO', 'valentina.silva@umbrella.cl', 'pass2'),
                                                                    (63, '60.000.003-3', 'Pablo Rivas', 'SECRETARIO', 'pablo.rivas@umbrella.cl', 'pass3'),
                                                                    (64, '60.000.004-4', 'Fernanda Díaz', 'SECRETARIO', 'fernanda.diaz@umbrella.cl', 'pass4'),
                                                                    (65, '60.000.005-5', 'Tomás Campos', 'SECRETARIO', 'tomas.campos@umbrella.cl', 'pass5'),
                                                                    (66, '60.000.006-6', 'Camila Soto', 'SECRETARIO', 'camila.soto@umbrella.cl', 'pass6'),
                                                                    (67, '60.000.007-7', 'Felipe Reyes', 'SECRETARIO', 'felipe.reyes@umbrella.cl', 'pass7'),
                                                                    (68, '60.000.008-8', 'Francisca Vidal', 'SECRETARIO', 'francisca.vidal@umbrella.cl', 'pass8'),
                                                                    (69, '60.000.009-9', 'Ignacio Pino', 'SECRETARIO', 'ignacio.pino@umbrella.cl', 'pass9'),
                                                                    (70, '60.000.010-0', 'Carla Muñoz', 'SECRETARIO', 'carla.munoz@umbrella.cl', 'pass10');

-- Tabla soportetecnico
INSERT INTO soporte_tecnico (id, rut, nombre, rol, correo, password) VALUES
                                                                         (71, '70.000.001-1', 'Admin', 'SOPORTETECNICO', 'admin@umbrella.cl', 'admin123'),
                                                                         (72, '70.000.002-2', 'Carla Muñoz', 'SOPORTETECNICO', 'carla.munoz@umbrella.cl', 'pass2'),
                                                                         (73, '70.000.003-3', 'Felipe Soto', 'SOPORTETECNICO', 'felipe.soto@umbrella.cl', 'pass3'),
                                                                         (74, '70.000.004-4', 'Antonia Reyes', 'SOPORTETECNICO', 'antonia.reyes@umbrella.cl', 'pass4'),
                                                                         (75, '70.000.005-5', 'Ignacio Pino', 'SOPORTETECNICO', 'ignacio.pino@umbrella.cl', 'pass5'),
                                                                         (76, '70.000.006-6', 'Tomás Silva', 'SOPORTETECNICO', 'tomas.silva@umbrella.cl', 'pass6'),
                                                                         (77, '70.000.007-7', 'Paula Rojas', 'SOPORTETECNICO', 'paula.rojas@umbrella.cl', 'pass7'),
                                                                         (78, '70.000.008-8', 'Diego Vera', 'SOPORTETECNICO', 'diego.vera@umbrella.cl', 'pass8'),
                                                                         (79, '70.000.009-9', 'Camila Soto', 'SOPORTETECNICO', 'camila.soto@umbrella.cl', 'pass9'),
                                                                         (80, '70.000.010-0', 'Felipe Reyes', 'SOPORTETECNICO', 'felipe.reyes@umbrella.cl', 'pass10');
