...
INSERT INTO paciente (id, rut, nombre, rol, correo, password, fecha_nacimiento) VALUES
                                                                                    (1, '20.000.001-1', 'Carlos Gómez', 'PACIENTE', 'carlos.gomez@correo.com', 'pass1', '1990-05-10'),
                                                                                    (2, '20.000.002-2', 'María Torres', 'PACIENTE', 'maria.torres@correo.com', 'pass2', '1985-08-22'),
                                                                                    (3, '20.000.003-3', 'Pedro Ramírez', 'PACIENTE', 'pedro.ramirez@correo.com', 'pass3', '2000-01-15'),
                                                                                    (4, '20.000.004-4', 'Lucía Fernández', 'PACIENTE', 'lucia.fernandez@correo.com', 'pass4', '1995-12-30'),
                                                                                    (5, '20.000.005-5', 'Javier Castro', 'PACIENTE', 'javier.castro@correo.com', 'pass5', '1988-03-05'),
                                                                                    (6, '20.000.006-6', 'Andrea Salas', 'PACIENTE', 'andrea.salas@correo.com', 'pass6', '1992-07-19'),
                                                                                    (7, '20.000.007-7', 'Rodrigo León', 'PACIENTE', 'rodrigo.leon@correo.com', 'pass7', '1983-11-23'),
                                                                                    (8, '20.000.008-8', 'Patricia Mora', 'PACIENTE', 'patricia.mora@correo.com', 'pass8', '1997-09-14'),
                                                                                    (9, '20.000.009-9', 'Sofía Navarro', 'PACIENTE', 'sofia.navarro@correo.com', 'pass9', '2001-02-28'),
                                                                                    (10, '20.000.010-0', 'Matías Herrera', 'PACIENTE', 'matias.herrera@correo.com', 'pass10', '1994-06-17');

-- Tabla enfermero
INSERT INTO enfermero (id, rut, nombre, rol, correo, password) VALUES
                                                                   (1, '30.000.001-1', 'Tomás Silva', 'ENFERMERO', 'tomas.silva@umbrella.cl', 'pass1'),
                                                                   (2, '30.000.002-2', 'Paula Rojas', 'ENFERMERO', 'paula.rojas@umbrella.cl', 'pass2'),
                                                                   (3, '30.000.003-3', 'Diego Vera', 'ENFERMERO', 'diego.vera@umbrella.cl', 'pass3'),
                                                                   (4, '30.000.004-4', 'Camila Soto', 'ENFERMERO', 'camila.soto@umbrella.cl', 'pass4'),
                                                                   (5, '30.000.005-5', 'Felipe Reyes', 'ENFERMERO', 'felipe.reyes@umbrella.cl', 'pass5'),
                                                                   (6, '30.000.006-6', 'Francisca Vidal', 'ENFERMERO', 'francisca.vidal@umbrella.cl', 'pass6'),
                                                                   (7, '30.000.007-7', 'Jorge Fuentes', 'ENFERMERO', 'jorge.fuentes@umbrella.cl', 'pass7'),
                                                                   (8, '30.000.008-8', 'Valentina Silva', 'ENFERMERO', 'valentina.silva@umbrella.cl', 'pass8'),
                                                                   (9, '30.000.009-9', 'Pablo Rivas', 'ENFERMERO', 'pablo.rivas@umbrella.cl', 'pass9'),
                                                                   (10, '30.000.010-0', 'Fernanda Díaz', 'ENFERMERO', 'fernanda.diaz@umbrella.cl', 'pass10');

-- Tabla gerente
INSERT INTO gerente (id, rut, nombre, rol, correo, password) VALUES
                                                                 (1, '40.000.001-1', 'Laura Méndez', 'GERENTE', 'laura.mendez@umbrella.cl', 'pass1'),
                                                                 (2, '40.000.002-2', 'Sergio Paredes', 'GERENTE', 'sergio.paredes@umbrella.cl', 'pass2'),
                                                                 (3, '40.000.003-3', 'Andrea Salas', 'GERENTE', 'andrea.salas@umbrella.cl', 'pass3'),
                                                                 (4, '40.000.004-4', 'Rodrigo León', 'GERENTE', 'rodrigo.leon@umbrella.cl', 'pass4'),
                                                                 (5, '40.000.005-5', 'Patricia Mora', 'GERENTE', 'patricia.mora@umbrella.cl', 'pass5'),
                                                                 (6, '40.000.006-6', 'Sofía Navarro', 'GERENTE', 'sofia.navarro@umbrella.cl', 'pass6'),
                                                                 (7, '40.000.007-7', 'Matías Herrera', 'GERENTE', 'matias.herrera@umbrella.cl', 'pass7'),
                                                                 (8, '40.000.008-8', 'Daniela Peña', 'GERENTE', 'daniela.pena@umbrella.cl', 'pass8'),
                                                                 (9, '40.000.009-9', 'Nicolás Bravo', 'GERENTE', 'nicolas.bravo@umbrella.cl', 'pass9'),
                                                                 (10, '40.000.010-0', 'Francisca Vidal', 'GERENTE', 'francisca.vidal@umbrella.cl', 'pass10');

-- Tabla quimicofarmaceutico
INSERT INTO quimico_farmaceutico (id, rut, nombre, rol, correo, password) VALUES
                                                                              (1, '50.000.001-1', 'Sofía Navarro', 'QUIMICOFARMACEUTICO', 'sofia.navarro@umbrella.cl', 'pass1'),
                                                                              (2, '50.000.002-2', 'Matías Herrera', 'QUIMICOFARMACEUTICO', 'matias.herrera@umbrella.cl', 'pass2'),
                                                                              (3, '50.000.003-3', 'Daniela Peña', 'QUIMICOFARMACEUTICO', 'daniela.pena@umbrella.cl', 'pass3'),
                                                                              (4, '50.000.004-4', 'Nicolás Bravo', 'QUIMICOFARMACEUTICO', 'nicolas.bravo@umbrella.cl', 'pass4'),
                                                                              (5, '50.000.005-5', 'Francisca Vidal', 'QUIMICOFARMACEUTICO', 'francisca.vidal@umbrella.cl', 'pass5'),
                                                                              (6, '50.000.006-6', 'Jorge Fuentes', 'QUIMICOFARMACEUTICO', 'jorge.fuentes@umbrella.cl', 'pass6'),
                                                                              (7, '50.000.007-7', 'Valentina Silva', 'QUIMICOFARMACEUTICO', 'valentina.silva@umbrella.cl', 'pass7'),
                                                                              (8, '50.000.008-8', 'Pablo Rivas', 'QUIMICOFARMACEUTICO', 'pablo.rivas@umbrella.cl', 'pass8'),
                                                                              (9, '50.000.009-9', 'Fernanda Díaz', 'QUIMICOFARMACEUTICO', 'fernanda.diaz@umbrella.cl', 'pass9'),
                                                                              (10, '50.000.010-0', 'Tomás Campos', 'QUIMICOFARMACEUTICO', 'tomas.campos@umbrella.cl', 'pass10');

-- Tabla secretario
INSERT INTO secretario (id, rut, nombre, rol, correo, password) VALUES
                                                                    (1, '60.000.001-1', 'Jorge Fuentes', 'SECRETARIO', 'jorge.fuentes@umbrella.cl', 'pass1'),
                                                                    (2, '60.000.002-2', 'Valentina Silva', 'SECRETARIO', 'valentina.silva@umbrella.cl', 'pass2'),
                                                                    (3, '60.000.003-3', 'Pablo Rivas', 'SECRETARIO', 'pablo.rivas@umbrella.cl', 'pass3'),
                                                                    (4, '60.000.004-4', 'Fernanda Díaz', 'SECRETARIO', 'fernanda.diaz@umbrella.cl', 'pass4'),
                                                                    (5, '60.000.005-5', 'Tomás Campos', 'SECRETARIO', 'tomas.campos@umbrella.cl', 'pass5'),
                                                                    (6, '60.000.006-6', 'Camila Soto', 'SECRETARIO', 'camila.soto@umbrella.cl', 'pass6'),
                                                                    (7, '60.000.007-7', 'Felipe Reyes', 'SECRETARIO', 'felipe.reyes@umbrella.cl', 'pass7'),
                                                                    (8, '60.000.008-8', 'Francisca Vidal', 'SECRETARIO', 'francisca.vidal@umbrella.cl', 'pass8'),
                                                                    (9, '60.000.009-9', 'Ignacio Pino', 'SECRETARIO', 'ignacio.pino@umbrella.cl', 'pass9'),
                                                                    (10, '60.000.010-0', 'Carla Muñoz', 'SECRETARIO', 'carla.munoz@umbrella.cl', 'pass10');

-- Tabla soportetecnico
INSERT INTO soporte_tecnico (id, rut, nombre, rol, correo, password) VALUES
                                                                         (1, '70.000.001-1', 'Admin', 'SOPORTETECNICO', 'admin@umbrella.cl', 'admin123'),
                                                                         (2, '70.000.002-2', 'Carla Muñoz', 'SOPORTETECNICO', 'carla.munoz@umbrella.cl', 'pass2'),
                                                                         (3, '70.000.003-3', 'Felipe Soto', 'SOPORTETECNICO', 'felipe.soto@umbrella.cl', 'pass3'),
                                                                         (4, '70.000.004-4', 'Antonia Reyes', 'SOPORTETECNICO', 'antonia.reyes@umbrella.cl', 'pass4'),
                                                                         (5, '70.000.005-5', 'Ignacio Pino', 'SOPORTETECNICO', 'ignacio.pino@umbrella.cl', 'pass5'),
                                                                         (6, '70.000.006-6', 'Tomás Silva', 'SOPORTETECNICO', 'tomas.silva@umbrella.cl', 'pass6'),
                                                                         (7, '70.000.007-7', 'Paula Rojas', 'SOPORTETECNICO', 'paula.rojas@umbrella.cl', 'pass7'),
                                                                         (8, '70.000.008-8', 'Diego Vera', 'SOPORTETECNICO', 'diego.vera@umbrella.cl', 'pass8'),
                                                                         (9, '70.000.009-9', 'Camila Soto', 'SOPORTETECNICO', 'camila.soto@umbrella.cl', 'pass9'),
                                                                         (10, '70.000.010-0', 'Felipe Reyes', 'SOPORTETECNICO', 'felipe.reyes@umbrella.cl', 'pass10');
